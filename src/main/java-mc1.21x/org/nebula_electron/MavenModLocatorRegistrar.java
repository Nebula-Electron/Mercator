...
/**
 * Mod locator for NeoForge on Minecraft 1.22+, reads jars from a local Maven repo.
 *
 ...
 *
 * <p>Lives in {@code META-INF/versions/25/} and takes over from the base stub on Java 25+.
 */
